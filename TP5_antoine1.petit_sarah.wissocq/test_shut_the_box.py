...
class TestJeuFermerBoiteLancerDes(unittest.TestCase):
	...
	def test_lance_des_fermer_tuile_deja_fermee_rollback_puis_redemande(self):
	...
	def test_si_ne_peut_plus_jouer_au_debut_tour_erreur(self):
		when(self.generateur_aleatoire_entre_1_et_6).generer_nombre().thenReturn(1).thenReturn(1)
		self.jeu.fermer_tuile(2)
		self.assertRaises(PeutPlusJouerError, self.jeu.lancer_des, 2)
